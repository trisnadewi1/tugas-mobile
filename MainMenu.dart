import 'package:karyawan/HeaderMenu.dart';
import 'package:karyawan/Karyawan.dart';
import 'package:karyawan/KaryawanReport.dart';
          ...
          onTap: () {
            ...
            if (imageText == "Karyawan") {
              Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => new Karyawan()));
            }
            if (imageText == "Absen") {}
            if (imageText == "Laporan") {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => new KaryawanReport()));
            }
            if (imageText == "Logout") {}
          },
          child: Column(
