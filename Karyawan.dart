import 'package:karyawan/MainMenu.dart';
import 'package:karyawan/Model/KaryawanModel.dart';
import 'package:karyawan/Repository/DbLite.dart';
import 'package:karyawan/WidgetHelper/PopupHelper.dart';
                  ...
                  Padding(
                    ...
                    child: new TextFormField(
                      ...
                      decoration: const InputDecoration(
                          labelText: 'No Telp', icon: Icon(Icons.phone)),
                            ...
                            child: new RaisedButton(
                              onPressed: () {
                                if (_formKey.currentState.validate()) {
                                  var karyawanModel = new KaryawanModel(
                                      nama: _ctrTxtName.text.trim(),
                                      telp: _ctrTxtPhone.text.trim(),
                                      email: _ctrTxtEmail.text.trim(),
                                      department: _idDepartment,
                                      jabatan: _idJabatan);
    ...
    Future.delayed(Duration(seconds: 3), () {
      db.saveKaryawan(karayawanModel).then((value) {
        if (value > 0) {
          ...
          Navigator.of(context, rootNavigator: true).pop();
          PopupHelper()
              .alertDialogCuprtinoMsg(context, "Oops, terjadi kesalahan!");
        }
      });
    });
  }
